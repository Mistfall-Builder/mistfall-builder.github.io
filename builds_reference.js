...
window.D_BUILDS = [
  /* ------------------------------------------------------------ MERCENARY */
  {
    ...
    d: {
      fr: "Le guide liste six affixes. Stoic 5, Unyielding 5 et Tenacious 5 sont les niveaux donnés tels quels par la source. Seeker (palier 4) et Aegis (palier 5) sont poussés à leur palier faute de niveau précisé ; Elusive, qui n'a pas de palier, reste à 3 comme partout ailleurs sur ce site.",
      en: "The guide lists six affixes. Stoic 5, Unyielding 5 and Tenacious 5 are the levels the source gives outright. Seeker (breakpoint 4) and Aegis (breakpoint 5) are pushed to their breakpoint since no level was given; Elusive, which has no breakpoint, stays at 3 as everywhere else on this site.",
      ru: 'Гайд перечисляет шесть аффиксов. Stoic 5, Unyielding 5 и Tenacious 5 — уровни, данные источником напрямую. Seeker (порог 4) и Aegis (порог 5) подняты до порога, так как уровень не был указан; у Elusive порога нет, он остаётся на 3, как и везде на этом сайте.',
    },
  },
  {
  ...
  /* ------------------------------------------------------------- SORCERER */
  {
    ...
    d: {
      fr: "La source donne ses six niveaux explicitement. Ranged 7 et Eloquence 7 sont les deux seuls affixes du site poussés jusqu'au cap absolu (7) ; le reste reste volontairement bas — Elusive 3, Aegis 3, Fervid 2, Fervor 1. Il faut de l'Excellent pour y arriver.",
      en: "The source gives all six levels explicitly. Ranged 7 and Eloquence 7 are the only two affixes on this site pushed to the absolute cap (7); the rest stays deliberately low — Elusive 3, Aegis 3, Fervid 2, Fervor 1. It takes Excellent gear to get there.",
      ru: 'Источник прямо даёт все шесть уровней. Ranged 7 и Eloquence 7 — единственные два аффикса на сайте, доведённые до абсолютного капа (7); остальное намеренно низкое — Elusive 3, Aegis 3, Fervid 2, Fervor 1. Нужен Excellent.',
    },
  },
  {
  ...
  /* ----------------------------------------------------------- BLACKARROW */
  {
    ...
    d: {
      fr: "KeenGamer classe Valor et Ranged comme les dégâts les plus fiables, Focused pour la vitesse de charge, Seamless et Elusive pour réduire les temps morts entre compétences — aucun niveau chiffré, les cinq passent donc à leur palier (3 pour Elusive, qui n'en a pas).",
      en: "KeenGamer ranks Valor and Ranged as the most reliable damage, Focused for charge speed, Seamless and Elusive to cut downtime between skills — no numeric level given, so all five sit at their breakpoint (3 for Elusive, which has none).",
      ru: 'KeenGamer ставит Valor и Ranged как самый надёжный урон, Focused — за скорость зарядки, Seamless и Elusive — чтобы сократить простои между умениями; числового уровня не дано, поэтому все пять на пороге (3 для Elusive, у которого порога нет).',
    },
  },
  {
  ...
  /* ---------------------------------------------------------- SHADOWSTRIX */
  {
    ...
    d: {
      fr: "KeenGamer classe Fervor et Valor « Essential », Vitality et Elusive « Very High », Seeker et Fervid « High ». Fervor 5 ajoute jusqu'à +10,5 % de dégâts en 5 stacks plus de la pénétration de défense ; les cinq autres sont à leur palier.",
      en: "KeenGamer ranks Fervor and Valor as \"Essential\", Vitality and Elusive as \"Very High\", Seeker and Fervid as \"High\". Fervor 5 adds up to +10.5 % damage across 5 stacks plus defense penetration; the other five sit at their breakpoint.",
      ru: 'KeenGamer относит Fervor и Valor к «обязательным», Vitality и Elusive — к «очень высоким», Seeker и Fervid — к «высоким». Fervor 5 даёт до +10,5 % урона на 5 стаках плюс пробитие защиты; остальные пять — на пороге.',
    },
  },
  {
    ...
    d: {
      fr: "La page donne une consigne de fin de partie resserrée à deux affixes : « 5 Valor + 5 Fervor comme apex central, la même paire vers laquelle convergent les guides de lancement ». Deux cibles seulement, et le stuff tient entièrement en Rare — le build le plus accessible de la liste.",
      en: "The page gives a tightened endgame target of just two affixes: \"5 Valor + 5 Fervor as the core apex, the same pairing the launch guides converge on.\" Two targets only, and the gear holds entirely in Rare — the most accessible build on this list.",
      ru: 'Страница даёт сжатую эндгейм-цель всего из двух аффиксов: «5 Valor + 5 Fervor как центральный апекс, та же пара, к которой сходятся стартовые гайды». Всего две цели, и снаряжение полностью держится на Rare — самая доступная сборка списка.',
    },
  },
  ...
  /* ----------------------------------------------------------------- SEER */
  {
    ...
    d: {
      fr: "Cette variante support : « les guides Reverent visent Seamless (temps de recharge), Eloquence (incantation plus rapide), Creation (durée des constructs plus longue) et Ranged (auto-attaques d'orbe plus fortes) », sans niveau chiffré — les quatre passent à leur palier, 5.",
      en: "This support variant: \"Reverent guides target Seamless (cooldown uptime), Eloquence (faster chants), Creation (longer construct duration), and Ranged (stronger orb auto-attacks)\", with no numeric level — all four sit at their breakpoint of 5.",
      ru: 'Этот саппорт-вариант: «гайды Reverent целятся в Seamless (аптайм перезарядки), Eloquence (быстрый каст), Creation (более долгие конструкты) и Ranged (усиленные автоатаки орбом)» — без числового уровня, все четыре на пороге 5.',
    },
  },
  {
  ...
  /* ------------------------------------------------------ WITHERED KNIGHT */
  {
    ...
    d: {
      fr: "Transcrit d'un guide vidéo. Les quatre affixes sont donnés explicitement au niveau/tier 5 : Burst, désigné numéro un, ajoute +25 % de dégâts d'exécution à son maximum (il plafonne justement à 5, sans palier). Valor, Tenacious et Aegis complètent en attaque, vie et défense.",
      en: "Transcribed from a video guide. All four affixes are given explicitly at level/tier 5: Burst, named the number-one pick, adds +25 % execution damage at its cap (it caps exactly at 5, with no breakpoint). Valor, Tenacious and Aegis round it out with attack, health and defense.",
      ru: 'Расшифровка видео-гайда. Все четыре аффикса даны явно на уровне/тире 5: Burst, названный выбором номер один, даёт +25 % урона добивания на максимуме (он как раз упирается в 5, без порога). Valor, Tenacious и Aegis дополняют атакой, здоровьем и защитой.',
    },
  },
  {
